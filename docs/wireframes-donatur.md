# ASCII Wireframes — Portal Donatur GBB
...
│  │ Kamu         │ │ Bulan Ini    │ │ Diikuti      │            │
│  └──────────────┘ └──────────────┘ └──────────────┘            │
│                                                                 │
│  ═══ History Konsistensi Donasi ══════════════════════════════  │
│                                                                 │
│  ┌──────────────────────────────────────────────────────────┐   │
│  │ Batch        │ Agt │ Sep │ Okt │ Nov │ Des │ Jan │ Feb  │   │
│  │ BBB4 (aktif) │ ✅  │ ✅  │ ✅  │ ✅  │ —   │ —   │ —    │   │
│  │ BBB3         │ ✅  │ ✅  │ ✅  │ ✅  │ ✅  │ ✅  │ —    │   │
│  └──────────────────────────────────────────────────────────┘   │
│                                                                 │
...
│  │ "Talkshow CV..."   │ │ "Beswan BBB4..."   │ │ "Growth..." │ │
│  │ 🔗 Lihat di IG     │ │ 🔗 Lihat di IG     │ │ 🔗 Lihat    │ │
│  └────────────────────┘ └────────────────────┘ └─────────────┘ │
└─────────────────────────────────────────────────────────────────┘
```
...
│  🎓 Jadilah Mentor GBB!                                        │
│                                                                 │
│  Kami membutuhkan mentor untuk agenda Growth & mentoring         │
│  beswan. Ada merchandise menarik untuk mentor terdaftar! 🎁     │
│                                                                 │
│  ┌──────────┐                                                   │
│  │ 🎓 12    │                                                   │
│  │ Mentor   │                                                   │
...
│  │  └──────────────────────────────────────┘                 │   │
│  │                                                           │   │
│  │  Upload CV *              LinkedIn URL                    │   │
│  │  ┌────────────────┐       ┌────────────────────────┐      │   │
│  │  │ 📎 Upload .pdf │       │ https://linkedin.com/  │      │   │
│  │  └────────────────┘       └────────────────────────┘      │   │
│  │                                                           │   │
│  │                                  [Daftar Jadi Mentor]     │   │
│  └───────────────────────────────────────────────────────────┘   │
...
│                                                                 │
│  ┌──────────────────────────────────────────────────────────┐   │
│  │ 💰 "Alhamdulillah, di semester ini GBB telah             │   │
│  │ mengumpulkan total Rp 15.200.000 dari 48 donatur aktif.  │   │
│  │ Sebesar 85% dialokasikan untuk pencairan beasiswa        │   │
│  │ langsung ke beswan..."                                    │   │
│  └──────────────────────────────────────────────────────────┘   │
│                                                                 │
│  ┌──────────────┐ ┌──────────────┐ ┌──────────────┐            │
│  │ 💰 15.2jt    │ │ 👥 48        │ │ 📊 85%       │            │
│  │ Total Dana   │ │ Donatur      │ │ Ke Beasiswa  │            │
│  │ Terkumpul    │ │ Aktif        │ │              │            │
│  └──────────────┘ └──────────────┘ └──────────────┘            │
│                                                                 │
│  ═══ Beswan Overview ═════════════════════════════════════════  │
...
│                                                                 │
│  Periode: [BBB4 (Jan-Jun 2026) ▼]                               │
│                                                                 │
│  🔍 Cari beswan...                                              │
│                                                                 │
│  ┌────────────────────┐ ┌────────────────────┐ ┌─────────────┐ │
│  │ 👤 Ahmad Fauzi     │ │ 👤 Siti Nurhaliza  │ │ 👤 Dewi K.  │ │
│  │                     │ │                     │ │              │ │
│  │ 📊 Update Terbaru:  │ │ 📊 Update Terbaru:  │ │ 📊 Terbaru: │ │
│  │ • Hadir 10/12 event │ │ • Hadir 11/12 event │ │ • 9/12 hadir│ │
│  │ • Juara 2 Essay     │ │ • Volunteer AIESEC  │ │ • IPK 3.6   │ │
│  │ • IPK 3.45          │ │ • IPK 3.78          │ │              │ │
│  │                     │ │                     │ │              │ │
│  │ Refleksi: 4/5 bulan │ │ Refleksi: 5/5 bulan │ │ 3/5 bulan   │ │
...
│  Laporan GBB                                                    │
│                                                                 │
│  🔍 Cari...  [Semua Tipe ▼] [Semua Periode ▼]                  │
│                                                                 │
│  ┌───┬──────────────────────────┬──────────┬────────┬──────────┐│
│  │ # │ Judul                    │ Tipe     │Periode │ Aksi     ││
│  ├───┼──────────────────────────┼──────────┼────────┼──────────┤│
│  │ 1 │ Booklet BBB4             │ Booklet  │ BBB4   │ 📥 Download│
│  │ 2 │ Laporan Keuangan Q1 2026 │ Keuangan │ BBB4   │ 📥 Download│
│  │ 3 │ Annual Report 2025       │ Tahunan  │ BBB3   │ 📥 Download│
│  └───┴──────────────────────────┴──────────┴────────┴──────────┘│
└─────────────────────────────────────────────────────────────────┘
```
