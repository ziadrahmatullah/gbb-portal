...
// Ganti password self-service beswan — dibuka dari dropdown user di topbar,
// sama dengan portal internal & donatur. Endpoint backend-nya sudah ada sejak
// awal; UI-nya menyusul atas masukan tim (Sep 2026).
    ...
    <Dialog open onOpenChange={(o: boolean) => !o && onClose()}>
      <DialogContent className="max-w-sm">
        <DialogHeader>
          ...
          <DialogDescription>Ubah password akun beswan kamu sendiri.</DialogDescription>
        </DialogHeader>
