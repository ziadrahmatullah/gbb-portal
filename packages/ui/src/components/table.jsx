...
function TableHead({ className, ...props }) {
    return (<th data-slot='table-head' className={cn('h-10 px-2 text-start align-middle font-medium whitespace-nowrap text-foreground *:[[role=checkbox]]:translate-y-0.5', className)} {...props}/>);
}
function TableCell({ className, ...props }) {
    return (<td data-slot='table-cell' className={cn('p-2 align-middle whitespace-nowrap *:[[role=checkbox]]:translate-y-0.5', className)} {...props}/>);
}
